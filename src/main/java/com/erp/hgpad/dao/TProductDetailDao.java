...
public interface TProductDetailDao extends JpaRepository<TProductDetail, String>,JpaSpecificationExecutor<TProductDetail> {
	...
	List<TProductDetail> findByProductIdAndStatusOrderByNoAsc(String productId, Integer status);
