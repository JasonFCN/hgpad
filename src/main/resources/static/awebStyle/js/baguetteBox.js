...
var baguetteBox = (function() {
    ...
    var leftArrow = '<a class="prev-box" href="javascript:void(0)"></a>',
        rightArrow ='<a class="next-box" href="javascript:void(0)"></a>',
        closeX = '<a class="close-box" href="javascript:void(0)"></a>';
    // Main ID names
